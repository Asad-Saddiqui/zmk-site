...
$sql = "SELECT property.*,(SELECT name FROM propertyimages WHERE pid = property.id LIMIT 1) AS homeImage, 
                                        ...
                                        WHERE 
                                            property.status = '1'  and purpose='Sale' 
...
<head>
    ...
    <!--	Title
	=========================================================-->
    <title>ZMK Selling Properties</title>
</head>
        ...
        <div class="row">
            ...
            <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Selling Property</b></h2>
