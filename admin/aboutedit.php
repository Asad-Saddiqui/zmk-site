...
if (isset($_POST['updateabout'])) {
  ...
  $sql = "UPDATE `about` SET `title`='$title',`feature`='$feature', `description` = '$description', `image_ab`='$aimage' WHERE `about`.`ab_id` = $id";
            ...
            <div class="full-row ">
                ...
                <div class="container my-4">
                    <h3 style="text-align: center;"> <a href="dashboard.php" style="color: white;">Dashboard</a>&nbsp;/
                        <a href="addproperty.php" style="color: green;"> Add Property
                        </a></h3>
                        ...
                        <form method="post" enctype="multipart/form-data" class="bg-secondary rounded">
                            <div class="description">
                                ...
                                <?php
									...
									$id=$_REQUEST['id'];
									$query=mysqli_query($con,"select * from about where ab_id='$id'");
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control my-2 bg-secondary text-light"
                                                    name="title" value="<?php echo $row['1'];?>" required placeholder="Enter Title" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" class="form-control my-2 bg-secondary text-light"
                                                    name="feature"  value="<?php echo $row['2'];?>"required placeholder="Enter Some Feature About .....! "  />
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea class="form-control bg-secondary text-light" name="description"
                                                    rows="10" cols="30"  placeholder="Enter some description  lated about us....."> <?php echo $row['3'];?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label">Image  </label>
                                            <div class="col-lg-9">
                                                <input type="file" class="form-control my-2 bg-secondary text-light"
                                                    name="aimage" required  />
                                                    <img src="../companylogo/<?php echo $row['4'];?>" alt="" style="width:200px;height:200px;">
                                            </div>
                                        </div>
