                        ...
                        <table id="myTable" class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                ?><tr>
                                        ...
                                        <td><a class="text-light" href=""=<?php echo $row['0']; ?>"><?php echo $row['2']; ?></a></td>
                                        <td>
                                        ...
                                        <td>
                                            <img src="./card/<?php echo $row['3']; ?>" alt="" srcset="" style="width: 70px;height:70px;border-radius:50%">
                                        </td>
                                        <td>
                                            <a class="text-light" href="@productUpdate.php?CID=<?php echo $row['0']; ?>"> <button class="btn btn-info"><i class="bi bi-pen"></i></button></a>
                                            <a class="text-light" href="@productDelete.php?id=<?php echo $row['0']; ?>"> <button class="btn btn-danger"><i class="bi bi-trash"></i></button></a>
