        ...
        <div class="content">
            ...
            <div class="full-row  m-2 rounded bg-secondary">
                <form method="post" enctype="multipart/form-data">
                    <h2 class="mt-2 pt-2 text-center">Update Listing</h2>
                    <?php echo $part1Error; ?>
                        ...
                        <div class="container-fluid pt-4 px-4 ">
                            <div class="container-fluid pt-4 px-4 bg-secondary">
                                <div class=" rounded-top p-4 bg-secondary">
                                    <div class="row col-md-12 col-sm-12 col-lg-12 bg-secondary ">

                                        <div class="col-md-6 col-sm-6 col-lg-6 text-center " style="color: white;
                                            font-weight: 900;
                                            font-size:20px;">
                                            <input type="submit" class="btn btn-info mt-2 text-center" onclick="customButtonClick()" name="next" style="width: 150px;" value="NextUpdated">
                                        </div>
                                    </div>
                                </div>
                            </div>
