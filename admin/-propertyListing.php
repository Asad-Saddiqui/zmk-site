...
if (isset($_POST['next'])) {
    ...
    if (empty(trim($cardType))) {
        ...
        header("location:-propertyListingduration.php?query=$cardType&id=$id");
    }
}

$query = "SELECT DISTINCT name FROM `card`";
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="container  rounded">
                        ...
                        <div class=" rounded-top p-4 bg-white m-3 border">
                            ...
                            <div class=" rounded-top p-4 bg-white " style="background-color:black;">
                                <div class="row row col-md-12 col-sm-12 col-lg-12">

                                    <div class="col-lg-2 col-sm-12 col-md-3 text-dark text-sm-start" style="color: black;
                                    font-weight: 900;
                                    font-size:20px;">
                                        Select Card
                                    ...
                                    <div class="col-lg-9 col-sm-12 col-md-8 text-center text-sm-start">
                                        ...
                                        <div class="form-group row col-lg-12 col-md-12 col-sm-12">
                                            <div class="col-lg-8 col-md-8 col-sm-12">
                                                <select class="form-select bg-white form-select-lg mb-3" name="cardType" aria-label=".form-select-lg example">
                                                    <?php
                                                    while ($row = mysqli_fetch_assoc($res)) {
                                                        $uniqueName = $row['name'];
                                                    ?>
                                                        <option value="<?php echo $uniqueName; ?>"><?php echo $uniqueName; ?></option>
                                                    <?php
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-12 text-center " style="color: black;
                                            font-weight: 900;
                                            font-size:20px;">
