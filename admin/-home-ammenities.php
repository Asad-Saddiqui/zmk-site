                                    ...
                                    <div class="row col-lg-12 col-md-12 col-sm-12">
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="row col-lg-12 col-md-12 col-sm-12 mt-3">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input placeholder="Enter near school  url location" type="url" value="<?= $numRow5 === 1 && (string)trim($data5['Nearby Schools']) ?  $data5['Nearby Schools'] : "" ?>" maxlength="450" class="form-control my-2 <?php  ?> bg-white text-dark" name="nearbySchools" id="nearbySchools" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label for="nearbyHospitals">Nearby Hospitals :</label>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="url" placeholder="Enter near hospitals  url location" value="<?= $numRow5 === 1 && (string)trim($data5['Nearby Hospitals']) ?  $data5['Nearby Hospitals'] : "" ?>" maxlength="450" class="form-control my-2 <?php  ?> bg-white text-dark" name="nearbyHospitals" id="nearbyHospitals" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label for="nearbyShoppingMalls">Nearby Shopping Malls :</label>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="url" placeholder="Enter Nearby Shopping Malls location" value="<?= $numRow5 === 1 && (string)trim($data5['Nearby Shopping Malls']) ?  $data5['Nearby Shopping Malls'] : "" ?>" maxlength="450" class="form-control my-2 <?php  ?> bg-white text-dark" name="nearbyShoppingMalls" id="nearbyShoppingMalls" style="background-color:white;" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="row col-lg-12 col-md-12 col-sm-12 mt-3">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="url" maxlength="450" placeholder="Enter Nearby Restaurants location" value="<?= $numRow5 === 1 && (string)trim($data5['Nearby Restaurants']) ?  $data5['Nearby Restaurants'] : "" ?>" class="form-control my-2 <?php  ?> bg-white text-dark" name="nearbyRestaurants" id="nearbyRestaurants" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label for="nearbyPublicTransportService">Nearby Public Transport Service :</label>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="url" placeholder="Enter Nearby Public Transport Service location" value="<?= $numRow5 === 1 && (string)trim($data5['Nearby Public Transport Service']) ?  $data5['Nearby Public Transport Service'] : "" ?>" maxlength="450" class="form-control my-2 <?php  ?> bg-white text-dark" name="nearbyPublicTransportService" id="nearbyPublicTransportService" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <label for="distanceFromAirport">Distance From Airport (kms) :</label>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="url" placeholder="Enter Nearby Airport location" value="<?= $numRow5 === 1 && (string)trim($data5['Distance From Airport (kms)']) ?  $data5['Distance From Airport (kms)'] : "" ?>" maxlength="450" class="form-control my-2 <?php  ?> bg-white text-dark" name="distanceFromAirport" id="distanceFromAirport" style="background-color:white;" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
