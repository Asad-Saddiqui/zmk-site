<div class="rounded-top p-4 bg-secondary border">
    <div class="row col-md-12 col-sm-12 col-lg-12">
        ...
        <div class="col-lg-2 col-sm-12 col-md-3 text-center text-sm-start" style="color: white;font-weight: 900;font-size:20px;">
        ...
        <div class="col-lg-9 col-sm-12 col-md-8 mt-2 text-center text-sm-start">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control bg-secondary text-white <?php echo $row['city'];  ?>" name="city" id="validationServer011" value="<?php echo $row['city'];  ?>">
                <div class="<?php  ?>">
                    <?php  ?>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control bg-secondary text-white <?php  ?>" name="location" id="validationServer012" value="<?=  `<iframe src='` . $row["location"] . `' width="640" height="480"></iframe>` ?>">
