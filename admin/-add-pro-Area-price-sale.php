            ...
            if ($num == 1) {
                ...
                if ($installments === 'Yes') {
                    if (
                        ...
                        `curency`='Pkr' WHERE `property`.`id` =$pid";
                    } else {
                        ...
                        <div class=" rounded-top p-4 bg-white m-3 border">
                            ...
                            <div id="forsell">
                                <div class="row bg-white">
                                    <div class="col-lg-2 col-sm-12 col-md-3 text-center text-sm-start" style="color: dark;
                                                    font-weight: 900;
                                                    font-size:20px;">
                                    ...
                                    <div class="col-lg-9 col-sm-12 col-md-8 text-center text-sm-start">
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group col-lg-8">
                                                ...
                                                <input type="text" class="form-control bg-white text-dark <?php  ?>" placeholder="Enter Area Size" name="area_size" id="validationServer013" value="<?php echo $row['size']; ?>">
                                                <div class="<?php  ?>">
                                                    <?php  ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="form-group col-lg-8">
                                                ...
                                                <input type="text" class="form-control bg-white text-dark <?php  ?>" placeholder="Enter Price" name="t_price_" id="validationServer013" value="<?php echo $row['price']; ?>">
                                                <div class="<?php  ?>">
                                                    <?php  ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-3 ">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input "style="background-color:#e9ecef" type="checkbox" value="Yes" name="installments" onclick="installment()" id="flexSwitchCheckDefault" style="    background-color: #989d98;
                                                                height: 21px;
                                                                width: 44px;">
                                                </div>
                                        ...
                                        <div id="installment1">
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control bg-white dark<?php  ?>" placeholder="Enter Advance Amount" name="advance_amount" id="validationServer013" value="<?php echo $row['advance']; ?>">
                                                    <div class="<?php  ?>">
                                                        <?php  ?>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group col-lg-8">
                                                ...
                                                <input type="text" class="form-control bg-white text-dark <?php  ?>" placeholder="Enter no of installment" name="n_installment" id="validationServer013" value="<?php echo $row['no_ins']; ?>">
                                                <div class="<?php  ?>">
                                                    <?php  ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group col-lg-8">
                                                    ...
                                                    <input type="text" class="form-control  bg-white dark<?php  ?>" placeholder="Enter Monthly Amount" name="monthly_amount" id="validationServer013" value="<?php echo $row['monthly_ins']; ?>">
                                                    <div class="<?php  ?>">
                                                        <?php  ?>
                                                    </div>
                                                </div>
...
<div class="row col-md-12 col-sm-12 col-lg-12 bg-white mt-2 ">

                                            <div class="col-md-4 col-sm-4 col-lg-4 " style="color: white;
                                            font-weight: 900;
                                            font-size:20px;">
                                            ...
                                            <div class="col-md-4 col-sm-4 col-lg-4 text-center mt-2 " style="color: white;
                                            font-weight: 900;
                                            font-size:20px;">
