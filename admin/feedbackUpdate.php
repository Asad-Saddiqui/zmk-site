...
if (isset($_POST['next'])) {
    ...
    if (empty(trim($show))) {
        ...
        $sql = "UPDATE `feedback` SET `status` = '1' WHERE `feedback`.`id` = $id;";
                                    ...
                                    <div class="col-lg-9 col-sm-12 col-md-8 text-center text-sm-start">
                                        ...
                                        <div class="form-group row col-lg-12 col-md-12 col-sm-12">
                                            <div class="col-lg-8 col-md-8 col-sm-12">
                                                <select class="form-select bg-white form-select-lg mb-3" name="show" aria-label=".form-select-lg example">
