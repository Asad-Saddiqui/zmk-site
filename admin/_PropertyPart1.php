    ...
    <div class="row col-md-12 col-sm-12 col-lg-12">
        ...
        <div class="col-lg-9 col-sm-12 col-md-8 mt-2 text-center text-sm-start">
            ...
            <div class="form-group my-2">
                <label for="validationServer011" class="form-label text-dark">Select Project</label>
                <select class="form-control bg-white text-dark"  name="Projectid">
                    <option value="">
                        Choose Project
                    </option>
                     <?php
                        $sql = "SELECT project_id, project_name FROM projects";
                         ...
                         if ($numN > 0) {
                            ...
                            ?>
                                ...
                                <option value="<?php echo $rowN['project_id']; ?>">
                        <?php echo $rowN['project_name'] ?>
                    </option>
                                   <?php
                                                        }
                                                    }
            ...
            <div class="row col-md-12 col-sm-12 col-lg-12 bg-white mt-2 ">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-lg-4  " style="color: black;
                                            font-weight: 900;
                                            font-size:20px;">
                                            <input type="submit" class="btn btn-outline-info mt-2" onclick="customButtonClick()" name="next" style="width: 150px;" value="Next">

                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4 mt-2 " style="color: black;
                                            font-weight: 900;
                                            font-size:20px;">
                                            <a href=""><button class="btn btn-outline-danger" disabled> Skip</button></a>
                                        </div>
                                    </div>
