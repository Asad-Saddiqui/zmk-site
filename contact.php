...
if (isset($_POST['send'])) {
	...
	$message = test_input1($message);
	if (!empty($name) && !empty($email) && !empty($phone) && !empty($message)) {

		$sql = "INSERT INTO `contact` (`conid`, `name`, `email`, `phone`, `message`) VALUES (NULL, '$name', '$email', '$phone', '$message');";
								...
								<ul>
									<li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
										<div class="contact-address">
											...
											<span class="text-white"><?php echo $myCompanyRow['compaddress'] ?></span> <br>
									...
									<li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
										<div class="contact-address">
											...
											<span class="d-table text-white"><?php echo $myCompanyRow['clandline'] ?></span>
											<span class="text-white"><?php echo $myCompanyRow['cphone'] ?></span>
										</div>
									</li>
									<li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
										<div class="contact-address">
											<h5 class="text-white">Email Adderss</h5>
											<span class="d-table text-white"><?php echo $myCompanyRow['compyemail'] ?></span>
										</div>
									</li>
								</ul>
							</div>
												...
												<div class="row mb-4">
													...
													<div class="col-lg-12">
														<div class="form-group">
															<textarea name="message" class="form-control" maxlength="750" rows="10" placeholder="Type Comments..."></textarea>
														</div>
													</div>
												</div>
												<button type="submit" value="send message" name="send" class="btn " style="background-color:#f36c21">Send Message</button>
											</div>
										</form>
									</div>
								</div>
