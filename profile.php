                ...
                <div class="container">
                    ...
                    <div class="dashboard-personal-info p-5 bg-white">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="message" rows="7" maxlength="450" placeholder="Enter Text Here...."></textarea>
                                    </div>
                        ...
                        <div class="col-lg-5 col-md-12">
                            ...
                            ?>
                                <div class="user-info mt-md-50"> <img src="./admin/common/user/<?php echo $row['img']; ?>" style="width: 100%;height:300px" alt="userimage">
                                    <div class="mb-4 mt-3">
