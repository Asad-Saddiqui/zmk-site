...
$sql = "SELECT property.*,(SELECT name FROM propertyimages WHERE pid = property.id LIMIT 1) AS homeImage, 
                                        ...
                                        WHERE 
                                            property.status = '1'  and ins_avalable='Yes' 
        ...
        <div class="row">
            ...
            <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Installment Property</b></h2>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                ?>
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                            <div class="featured-thumb hover-zoomer mb-4">
                                                <div class="overlay-black overflow-hidden position-relative"> <img src="./admin/uploads/<?php echo $row['homeImage']; ?>" alt="pimage" style="height: 200px;width:100%">
                                                    <div class="featured bg-success text-white"><?php echo $row['cardName']; ?></div>
                                                    <div class="sale bg-success text-white text-capitalize">For <?php echo $row['purpose']; ?></div>
                                                    <div class="price text-primary"><b>$<?php echo $row['price']; ?> </b><span class="text-white"><?php echo $row['size']; ?> <?php echo $row['size_in']; ?> | <?php echo $row['propertyType']; ?></span></div>
                                                </div>
                                                <div class="featured-thumb-data shadow-one">
                                                    <div class="p-3">
                                                        <h5 class="text-secondary hover-text-success mb-2 text-capitalize d-flex justify-content-between"><a href="propertydetail.php?pid=<?php echo $row['id']; ?>"><?php echo $row['title']; ?></a>
                                                            <div class=" d-flex justify-content-between">
                                                                ...
                                                                <p class="mx-2">
                                                                    <button class="bg-white text-success">
                                                    ...
                                                    <div class="p-4 d-inline-block w-100">
                                                        <div class="float-left text-capitalize"><i class="fas fa-user text-success mr-1"></i>By : <?php echo $row['name']; ?></div>
                                                        <div class="float-right"><i class="far fa-calendar-alt text-success mr-1"></i> <?php echo date('d-m-Y', strtotime($row['listingDate'])); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="pagination justify-content-center mt-4 row col-md-12 col-lg-12 col-sm-12 ">
                                                ...
                                                ?>
                                                    <li class="page-item <?php
                                                                            ...
                                                                            ?>  col-md-1 col-sm-2  my-2 " id="mydiv" aria-current="page"> <a class="page-link" href="property.php?page=<?php
                                                                                                                                                                                        echo $pages = $i;
