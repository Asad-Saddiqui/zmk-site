...
if (isset($_REQUEST['calc'])) {
    ...
    if (empty($amount) || empty($mon) || empty($int)) {
        return;
    } else {
        ...
        <div class="row">
            ...
            <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Calculator</b></h2>
                        </div>
                        <div class="col-md-6">
                        ...
                        <table class="items-list col-lg-6 table-hover" style="border-collapse:inherit;">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td><b><?php echo 'Pkr ' . $interest; ?></b></td>
                                </tr>
                                <tr class="text-center">
                                    <td><b>Total Amount</b></td>
                                    <td><b><?php echo 'Pkr ' . $pay; ?></b></td>
                                </tr>
                                <tr class="text-center">
                                    <td><b>Pay Per Month (EMI)</b></td>
                                    <td><b><?php echo 'Pkr ' . $month; ?></b></td>
                                </tr>
