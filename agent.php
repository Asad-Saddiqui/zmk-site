...
$sql = "SELECT user.*, profile.*, COALESCE(property_count.property_count, 0) AS property_count
                                            FROM user
                                            ...
                                            WHERE user.role = 'agent' AND user.varified = 1 lIMIT $offset,$records_per_page";
$sql2 = "SELECT * FROM user where role='agent' AND varified =1";
        ...
        <div class="row">
            ...
            <div class="banner-full-row page-banner" style="background-image:url('images/breadcromb.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <h2 class="page-name float-left text-white text-uppercase mt-1 mb-0"><b>Agents Grid</b></h2>
                                        ...
                                        <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                                            <div class="featured-thumb hover-zoomer mb-4">
                                                ...
                                                <div class="featured-thumb-data shadow-one">
                                                    <div class="p-1">
                                                        <h5 class="text-secondary hover-text-success text-capitalize"><a href="agentDetails.php?id=<?php echo $row['id']; ?>"><?php echo $row['name']; ?></a></h5>
                                                        <span class="location text-capitalize"><i class="fas fa-envelope text-success"></i> <?php echo $row['email']; ?></span>
                                                    </div>

                                                    <div class="p-1 d-inline-block w-100">
                                                        <div class="float-left text-capitalize"><i class="fas fa-list text-success mr-1"></i>Listing Properties : <?php echo $row['property_count']; ?></div>
