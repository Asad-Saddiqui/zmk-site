...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($purpose) || empty($propertyType) || empty($propertySubtype) || empty($city) || empty($location)) {
        ...
        $sql = "INSERT INTO `property` (`id`, `uid`, `purpose`, `propertyType`, `propertySubtype`, `city`, `location`)
         VALUES (NULL, '$uid', '$purpose', '$propertyType', '$propertySubtype', '$city', '$location')";
        if ($con->query($sql) === TRUE) {
            $lastInsertId = $con->insert_id;
            propertyStatus($con, $uid, $lastInsertId, "INSERT INTO `complete` (`comid`, `pid`, `uid`, `status1`, `1`, `2`, `3`, `4`, `5`, `6`) 
                            ...
                            <div class="container-fluid pt-4 px-4 bg-white">
                                <div class=" rounded-top p-4 bg-white">
                                    <div class="row col-md-12 col-sm-12 col-lg-12 bg-white ">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-lg-4 text-center " style="color: black;
                                            font-weight: 900;
                                            font-size:20px;">
                                            <a href=""><button class="btn btn-outline-dark" disabled> Back</button></a>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-lg-4 text-center " style="color: black;
                                            font-weight: 900;
                                            font-size:20px;">
