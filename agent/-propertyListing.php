...
$query = "SELECT * FROM oder JOIN card ON card.id = oder.cid where oder.uid = '$uid' and oder.Quantity >0;";
                        ...
                        <div class=" rounded-top p-4 bg-white m-3 border">
                            ...
                            <div class=" rounded-top p-4 bg-white " style="background-color:white;">
                                <div class="row row col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="col-lg-2 text-dark col-sm-12 col-md-3 text-center text-sm-start" style="color: white;
                                    font-weight: 900;
                                    font-size:20px;">
                                        Select Card :
