...
$query1 = "SELECT * FROM property WHERE id=$pid and  uid='$uid'";
...
if (!empty($pid)) {
    ...
    if (isset($_POST['next'])) {
        ...
        if (!empty($posting_as_a) && !empty($posting_email) && !empty($posting_number) && !empty($posting_landline)) {
            ...
            if ($num == 1) {
                $sql = "UPDATE `property` SET `posting` = '$posting_as_a', `email`='$posting_email',`mobile` = '$posting_number', `landline`='$posting_landline' WHERE `property`.`id` =$pid and `property`.`uid`='$uid'";
                if ($con->query($sql) === TRUE) {
                    propertyStatus($con, $uid, $pid, "UPDATE `complete` SET `5` = '1' WHERE `complete`.`uid` = $uid AND `pid`=$pid ;");
                                ...
                                <div class="row row col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <div class="col-lg-9 col-sm-12 col-md-8 text-center text-sm-start">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-2 col-form-label" for="validationServer013">Plateform</label>
                                ...
                                <div class="container-fluid pt-4 px-4 bg-white">
                                    <div class=" rounded-top p-4 bg-white">
                                        <div class="row col-md-12 col-sm-12 col-lg-12 bg-white ">
                                            ...
                                            font-weight: 900;
                                            font-size:20px;">
                                                <button class="btn btn-outline-danger"> <a href="
