        ...
        <div class="content bg-light">
                                            ...
                                            <div class="row col-lg-12 col-md-12 col-sm-12 mt-3">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="text" maxlength="40" value="<?php
                                                                                                ...
                                                                                                ?>" class="form-control my-2 <?php  ?>bg-white text-dark" name="nearbySchools" id="nearbySchools" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="text" maxlength="40" value="<?php
                                                                                                ...
                                                                                                ?>" class="form-control my-2 <?php  ?>bg-white text-dark" name="nearbyHospitals" id="nearbyHospitals" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="text" maxlength="40" value="<?php
                                                                                                ...
                                                                                                ?>" class="form-control my-2 <?php  ?>bg-white text-dark" name="nearbyShoppingMalls" id="nearbyShoppingMalls" style="background-color:white;" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12">
                                            <div class="row col-lg-12 col-md-12 col-sm-12 mt-3">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="text" maxlength="40" value="<?php
                                                                                                ...
                                                                                                ?>" class="form-control my-2 <?php  ?> bg-white text-dark" name="nearbyRestaurants" id="nearbyRestaurants" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="text" maxlength="40" value="<?php
                                                                                                ...
                                                                                                ?>" class="form-control my-2 <?php  ?> bg-white text-dark" name="nearbyPublicTransportService" id="nearbyPublicTransportService" style="background-color:white;" />
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    <input type="text" maxlength="40" value="<?php
                                                                                                ...
                                                                                                ?>" class="form-control my-2 <?php  ?> bg-white text-dark" name="distanceFromAirport" id="distanceFromAirport" style="background-color:white;" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container-fluid  pt-4 px-4">
                <div class="bg-white rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center bg-white text-sm-start">
